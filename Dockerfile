...
ENV TFLINT_VERSION=0.19.0
ENV KUBECTL_VERSION=1.18.8
ENV HELM_VERSION=3.3.0
ENV SONOBUOY_VERSION=0.18.4
ENV ISTIO_VERSION=1.7.0
ENV CONSUL_VERSION=1.8.3
ENV CONSUL_SHA256SUM=b72e9eac5405c691c2e3b50819900ca84a79f2f6e7d73aa91f2a336fc2bcacb0
ENV VAULT_VERSION=1.5.2
ENV VAULT_SHA256SUM=cdce8a02059fe660ba4e25532ed6fc394549f08c7cab6e02e4bc3d6683de3ad5
...
RUN sudo apk add --no-cache \
    ...
    sudo pip3 install --upgrade pip==20.2.2 && \
